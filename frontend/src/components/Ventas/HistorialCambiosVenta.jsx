  ...
  useEffect(() => {
    ...
    const url =
      esOwner && !sucursalFiltro
        ? `${API_URL}/ventas/cambios/listado?todas=1&limit=500`
        : `${API_URL}/ventas/cambios/listado?sucursal_id=${sidEfectivo}&limit=500`;
    axios
      .get(url, {
    ...
    <div className="p-8">
      <div className="mb-6 text-left">
        ...
        <p className="text-slate-500 text-sm mt-0.5 max-w-3xl">
          ...
          {esOwner ? " Como dueña ves todas las sucursales hasta que elijas una para filtrar." : ""}
        </p>
      </div>
      ...
      <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden mb-6">
        <div className="p-4 border-b border-slate-100 flex flex-col sm:flex-row sm:items-center gap-4">
          <div className="relative max-w-md flex-1">
            ...
            <input
              ...
              disabled={!esOwner && sidEfectivo == null}
            />
          </div>
        ...
        {loading ? (
          ...
          <p className="text-center py-14 text-slate-500 text-sm">
            {esOwner && !sucursalFiltro
              ? "No hay cambios registrados en el sistema."
              : "No hay cambios que coincidan con esta sucursal o con la búsqueda."}
          </p>
        ) : (
          <>
